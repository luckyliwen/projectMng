...
public interface ServiceConstant {
	...
	public static final String REGISTRATION_COUNT_ALL_PROJECT="GetCountForAllProject";
	public static final String REGISTRATION_COUNT_SUB_PROJECT="GetCountForSubProject"; 
